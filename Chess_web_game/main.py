	...
	def run(self, external_commands):
		...
		while 1:
			...
			for figure in curr_player.figures:
				# print(figure.name, figure_print, "\n", figure.player, curr_player.color, 
				# 	"\n", chr(figure.curr_pos_ltr), src_letter,
			...
			# if self.passed == 0 and self.ok == 1:
			# 	print("hehe")
			if self.ok == 0 or self.passed == 0:
				continue
...
# pre_moves = ["A2-A4", "B7-B5", "C2-C4", "D7-D5", "E2-E4", "F7-F5", "G2-G4", "H7-H5", "A4-B5", "D5-C4",
# 				"E4-F5", "H5-G4", "A1-C1", "A1-A10", "A1-B3", "A1-C3", "A1-A5", "G8-G7", "G8-G5", "G8-H7", 
# 				"G8-F5", "G8-H6", "A5-D5", "C1-B2", "C1-A3", "C1-D2", "C1-F4", "C1-C3", 
# 				"D1-D2", "D1-D4", "D1-H5", "D1-B3", "E8-E7", "E8-E5", "E8-F8", "E8-F7", 
# 				"F1-D3", "exit"]
