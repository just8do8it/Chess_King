					...
					chr(figure.curr_pos_ltr) == src_letter and figure.curr_pos_num == src_number:
						...
						if type(result) == type(true):
							...
							if curr_player.color == "white":
								for figure in self.b_player.figures:
									if figure.name == taken_figure:
										figure.is_alive = 0
										self.w_player.won_figures.append(figure.name)
							else:
								for figure in self.w_player.figures:
									if figure.name == taken_figure:
										figure.is_alive = 0
										self.b_player.won_figures.append(figure.name)
