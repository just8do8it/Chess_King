			...
			if self.player == "white":
				...
				if new_ltr == self.curr_pos_ltr and new_pos_num == self.curr_pos_num + 1:
					...
					if self.board[new_pos_num - 1][new_pos_ltr] != "  ":
						...
						self.curr_pos_num = new_pos_num
						result = (True, new_pos_num, new_ltr)
					else:
						print("weird")
						return False
				...
				if result[0] == True:
					print(self.board[new_pos_num][new_pos_ltr + 1])
					if self.board[new_pos_num][new_pos_ltr + 1] != "  ":
						able_to_kill_pos.append((new_pos_num, new_pos_ltr + 1))
					if self.board[new_pos_num][new_pos_ltr - 1] != "  ":
						able_to_kill_pos.append((new_pos_num, new_pos_ltr - 1))
				...
				if result[0] == True:
					if self.board[new_pos_num - 2][new_pos_ltr + 1] != "  ":
						able_to_kill_pos.append((new_pos_num, new_pos_ltr + 1))
					if self.board[new_pos_num - 2][new_pos_ltr - 1] != "  ":
						able_to_kill_pos.append((new_pos_num, new_pos_ltr - 1))
